...
class Model
{
	...
	public:
        ...
        //Not sure what to set as default value for Char?
        CharField* charField(string name, char defaultValue='\0', bool primary=false, bool unique=false, bool nullable=true);
