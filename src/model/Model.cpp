...
FileField* Model::fileField(string fieldName, string folderPath, string defaultValue, bool isPrimaryKey, bool isUnique, bool isNullable) {
    FileField * f = new FileField(fieldName, folderPath, defaultValue, isPrimaryKey, isUnique, isNullable);
    fields.push_back(f);
